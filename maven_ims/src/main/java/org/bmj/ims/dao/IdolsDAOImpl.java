...
implements IdolsDAO{
	...
	public Idol selectOne(Map<String, Object> map) {
		return session.selectOne("idols.selectOneLike",map);
	}
	...
	@Override
	public void updateLikeCount(int typeNo) {
	 session.update("idols.updateLikeCount",typeNo);
	}
