...
<button id="likeBtn" class="btn  <c:if test="${idol.ownCount==1}">on</c:if>" form="likeForm">
	<i class="far fa-heart"></i>
	<i class="fas fa-heart"></i>
	<span class="like_count">${idol.likeCount}</span>
</button>
<form id="likeForm" action="/idol/like" method="post">
